                    ...
                    <div className="grid grid-cols-6 lg:grid-cols-12 items-center justify-center">
                        ...
                        <div className="flex flex-col col-span-6 md:col-span-8 ps-5 pt-4 lg:pt-0">
                            ...
                            <p className="text-base text-foreground/60">
                                Computer Science Co-op Baccalaureate at
                                Concordia University
                            </p>
                            <h2 className="text-lg text-pretty mt-6">
                                Combining my Computer Science background with a
                                focus on Machine Learning and Software
                                Development, I delve into the intricacies of AI.
                                Beyond coding, I find joy in playing chess,
                                immersing myself in video games, pursuing
                                modeling as a hobby, exploring the great
